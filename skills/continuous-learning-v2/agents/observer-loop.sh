...
analyze_observations() {
  ...
  analysis_file="$(mktemp "${observer_tmp_dir}/multiversal-observer-analysis.XXXXXX.jsonl")"
  ...
  prompt_file="$(mktemp "${observer_tmp_dir}/multiversal-observer-prompt.XXXXXX")"
