...
description: >-
  Analyze raw prompts, identify intent and gaps, match Multiversal components
...
Analyze a draft prompt, critique it, match it to Multiversal ecosystem components,
...
- User says "how should I use Multiversal for..."
...
- User is asking about Multiversal configuration (use `configure-multiversal` instead)
...
### Phase 3: Multiversal Component Matching

Map intent + scope + tech stack (from Phase 0) to specific Multiversal components.
...
### Section 2: Recommended Multiversal Components
...
A compact version for experienced Multiversal users. Vary by intent type:
...
- "Optimize this prompt for Multiversal"
- "Rewrite this prompt so Claude Code uses the right commands"
- "帮我优化这个指令"
- "How should I prompt Multiversal for this task?"
...
|-----------|------------------|
| `configure-multiversal` | User hasn't set up Multiversal yet |
