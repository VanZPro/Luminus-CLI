...
| Port/Rebuild | useful idea, but should be manually re-landed inside Multiversal |
...
- External-source features should be rebuilt inside Multiversal when they are valuable but not self-contained
...
- "Map GitHub issues into our Multiversal 1.x and Multiversal 2.0 program lanes"
