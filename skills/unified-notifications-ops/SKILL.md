...
description: Operate notifications as one Multiversal-native workflow across GitHub, Linear, desktop alerts, hooks, and connected communication surfaces. Use when the real problem is alert routing, deduplication, escalation, or inbox collapse.
origin: Multiversal
---
...
- the user wants to consolidate overlapping notification branches or backlog proposals into one Multiversal-native lane
...
Prefer Multiversal-native orchestration over telling the user to adopt a separate notification product.
...
Call out what Multiversal already owns.
...
### 4. Design the Multiversal-native workflow
...
If Multiversal already has the primitive, prefer:
...
- what to suppress
- what to merge
- what Multiversal should wrap next
...
- "Collapse overlapping notification PR ideas into one canonical Multiversal lane"
