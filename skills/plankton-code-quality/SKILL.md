...
1. Install Multiversal as your plugin (agents, skills, commands, rules)
2. Add Plankton hooks for write-time quality enforcement
3. Use AgentShield for security audits
4. Use Multiversal's verification-loop as a final gate before PRs

### Avoiding Hook Conflicts

If running both Multiversal and Plankton hooks:
- Multiversal's Prettier hook and Plankton's biome formatter may conflict on JS/TS files
- Resolution: disable Multiversal's Prettier PostToolUse hook when using Plankton (Plankton's biome is more comprehensive)
- Both can coexist on different file types (Multiversal handles what Plankton doesn't cover)
