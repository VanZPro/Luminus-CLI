...
5. If site copy matters, include the current Multiversal landing page and repo/plugin framing.
...
## Affaan / Multiversal Defaults

If the user wants Affaan / Multiversal voice and live sources are thin, start here unless newer source material overrides it:
