---
name: multiversal-tools-cost-audit
description: Evidence-first Multiversal Tools burn and billing audit workflow. Use when investigating runaway PR creation, quota bypass, premium-model leakage, duplicate jobs, or GitHub App cost spikes in the Multiversal Tools repo.
origin: Multiversal
---

# Multiversal Tools Cost Audit

Use this skill when the user suspects the Multiversal Tools GitHub App is burning cost, over-creating PRs, bypassing usage limits, or routing free users into premium analysis paths.

This is a focused operator workflow for the sibling [Multiversal-Tools](../../Multiversal-Tools) repo. It is not a generic billing skill and it is not a repo-wide code review pass.
...
- user says Multiversal Tools burn rate, PR recursion, over-created PRs, usage-limit bypass, or premium-model leakage
- the task is in the sibling `Multiversal-Tools` repo and depends on webhook handlers, queue workers, usage reservation, PR creation logic, or paid-gate enforcement
...
- work in the sibling `Multiversal-Tools` repo, not in `everything-claude-code`
...
- switch into the sibling `Multiversal-Tools` repo
