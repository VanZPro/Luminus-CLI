...
description: Orchestrate fixing a bug — reproduce it as a failing regression test, fix to green, review, and gated commit — by delegating each phase to the matching Multiversal agent. Use when existing behavior is broken or wrong.
origin: Multiversal
---
