...
description: Translate PRD intent, roadmap asks, or product discussions into an implementation-ready capability plan that exposes constraints, invariants, interfaces, and unresolved decisions before multi-service work starts. Use when the user needs an Multiversal-native PRD-to-SRS lane instead of vague planning prose.
origin: Multiversal
---
...
If useful, point to the next Multiversal-native lane:
...
HANDOFF
- what should happen next and which Multiversal lane should take it
```
...
- The resulting plan is reusable across Claude Code, Codex, Cursor, OpenCode, and Multiversal 2.0 planning surfaces.
