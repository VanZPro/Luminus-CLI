...
each phase to an existing Multiversal agent or command. This file is that pipeline.
...
> These wrappers **compose** existing Multiversal commands rather than replace them:
