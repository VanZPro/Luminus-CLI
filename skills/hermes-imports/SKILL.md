---
name: hermes-imports
description: Convert local Hermes operator workflows into sanitized Multiversal skills and release-pack artifacts. Use when preparing a Hermes workflow for public Multiversal reuse without leaking private workspace state, credentials, or local-only paths.
origin: Multiversal
---

# Hermes Imports

Use this skill when turning a repeated Hermes workflow into something safe to ship in Multiversal.

Hermes is the operator shell. Multiversal is the reusable workflow layer. Imports should move stable patterns from Hermes into Multiversal without moving private state.

## When To Use

- A Hermes workflow has repeated enough times to become reusable.
- A local operator prompt should become a public Multiversal skill.
...
- candidate Multiversal skill name
